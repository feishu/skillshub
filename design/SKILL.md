---
name: design
description: Handle broad design work across brand identity, design systems, UI styling, logos, banners, icons, slides, and social visuals. Use when a request spans multiple design disciplines and needs routing to the right design workflow or resource.
license: MIT
metadata:
  author: claudekit
  version: "2.1.0"
